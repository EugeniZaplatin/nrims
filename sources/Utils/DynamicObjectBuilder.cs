...
namespace Noris.Services.Utils
{
    public  class DynamicObjectBuilder
    {
        ...
        public static object CreateOurNewObject(XmlDocument xDoument, Type type)
        {
            ...
            TypeBuilder typeBuilder = module.DefineType("BindableRowCellCollection", TypeAttributes.Public | TypeAttributes.Class, type);

            // Loop over the attributes that will be used as the properties names in out new type
            foreach (XmlNode node in xDoument.SelectSingleNode("root").ChildNodes)
            {
